...
## Notes
No source code changes. Build and lint should be unaffected. Integration test failures are expected: tags (empty table), images (special ID format), guests (not a node resource).
